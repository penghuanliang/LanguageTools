...
from xml_to_xsls import GenerateXLSX
...
class UiXMLToXLSX:
    ...
    def run(self):
        ...
        GenerateXLSX().generate_xsl(self.e1.get(), self.e2.get())
        self.show_msg("导出完毕成功！")
    ...
    def __init__(self, parent):
        ...
        Label(master=frame, text='选择一个将要输出的 .xlsx 或 xls', font=('Arial', 14)).grid(row=2, column=0, sticky=W, padx=15)
